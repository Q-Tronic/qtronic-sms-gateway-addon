...
async def final_step():
    ...
    if CORE.is_esp32 and CORE.has_networking:
        # Keep the upstream wake-on-RX behavior for ESP32. On this ESP8266
        # gateway the software UART receives SIM800C traffic in an ISR, and
        # scheduling the network loop after every byte correlates with
        # Hardware WDT resets in wDev_ProcessFiq. The normal ESP8266 main loop
        # still drains the 256-byte RX buffer comfortably at 9600 baud.
